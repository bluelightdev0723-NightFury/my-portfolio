...
export function Skills() {
  return (
    <section id="skills" className="relative overflow-hidden section-padding-compact">
      <StarfieldBackdrop />
      <div className="relative mx-auto max-w-7xl">
        <SectionHeading
          label="Skills"
          title="Tech stack"
          subtitle="A focused toolkit spanning mobile development, AI, architecture, APIs, and connected technologies."
        />
