...
export function Experience() {
  ...
  return (
    <section id="experience" className="relative overflow-hidden section-padding-compact bg-bg-surface/30">
      <StarfieldBackdrop />
      <div className="relative mx-auto max-w-7xl">
        <SectionHeading
          label="Experience"
          title="Career journey"
          subtitle="11+ years building mobile applications, AI-powered experiences, and connected products across multiple industries."
        />
